#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent5-self-hosting.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent5-self-hosting.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent5-self-hosting.output"
REC_ID="agent5-self-hosting"
