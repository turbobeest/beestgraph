#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent2-botmeetbot.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent2-botmeetbot.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent2-botmeetbot.output"
REC_ID="agent2-botmeetbot"
