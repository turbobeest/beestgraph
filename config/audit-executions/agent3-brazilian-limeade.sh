#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent3-brazilian-limeade.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent3-brazilian-limeade.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent3-brazilian-limeade.output"
REC_ID="agent3-brazilian-limeade"
