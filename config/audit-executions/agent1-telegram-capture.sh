#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent1-telegram-capture.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent1-telegram-capture.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent1-telegram-capture.output"
REC_ID="agent1-telegram-capture"
