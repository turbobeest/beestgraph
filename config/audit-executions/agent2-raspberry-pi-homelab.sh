#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent2-raspberry-pi-homelab.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent2-raspberry-pi-homelab.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent2-raspberry-pi-homelab.output"
REC_ID="agent2-raspberry-pi-homelab"
