#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent1-3d-knowledge-graph-viewer.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent1-3d-knowledge-graph-viewer.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent1-3d-knowledge-graph-viewer.output"
REC_ID="agent1-3d-knowledge-graph-viewer"
