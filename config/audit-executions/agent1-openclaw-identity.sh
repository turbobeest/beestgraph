#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent1-openclaw-identity.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent1-openclaw-identity.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent1-openclaw-identity.output"
REC_ID="agent1-openclaw-identity"
