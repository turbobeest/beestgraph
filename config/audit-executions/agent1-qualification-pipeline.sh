#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent1-qualification-pipeline.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent1-qualification-pipeline.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent1-qualification-pipeline.output"
REC_ID="agent1-qualification-pipeline"
