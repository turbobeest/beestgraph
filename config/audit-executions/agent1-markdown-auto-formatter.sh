#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent1-markdown-auto-formatter.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent1-markdown-auto-formatter.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent1-markdown-auto-formatter.output"
REC_ID="agent1-markdown-auto-formatter"
