#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent5-meet-the-parents.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent5-meet-the-parents.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent5-meet-the-parents.output"
REC_ID="agent5-meet-the-parents"
