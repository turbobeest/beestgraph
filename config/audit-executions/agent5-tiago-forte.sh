#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent5-tiago-forte.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent5-tiago-forte.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent5-tiago-forte.output"
REC_ID="agent5-tiago-forte"
