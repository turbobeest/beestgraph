#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent1-mobile-qualification-review.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent1-mobile-qualification-review.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent1-mobile-qualification-review.output"
REC_ID="agent1-mobile-qualification-review"
