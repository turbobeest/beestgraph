#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent2-gencad.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent2-gencad.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent2-gencad.output"
REC_ID="agent2-gencad"
