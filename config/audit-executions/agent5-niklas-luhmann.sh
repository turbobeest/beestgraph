#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent5-niklas-luhmann.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent5-niklas-luhmann.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent5-niklas-luhmann.output"
REC_ID="agent5-niklas-luhmann"
