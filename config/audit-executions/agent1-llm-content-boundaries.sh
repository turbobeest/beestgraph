#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent1-llm-content-boundaries.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent1-llm-content-boundaries.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent1-llm-content-boundaries.output"
REC_ID="agent1-llm-content-boundaries"
