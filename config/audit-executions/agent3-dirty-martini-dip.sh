#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent3-dirty-martini-dip.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent3-dirty-martini-dip.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent3-dirty-martini-dip.output"
REC_ID="agent3-dirty-martini-dip"
