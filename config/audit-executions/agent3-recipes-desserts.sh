#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent3-recipes-desserts.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent3-recipes-desserts.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent3-recipes-desserts.output"
REC_ID="agent3-recipes-desserts"
