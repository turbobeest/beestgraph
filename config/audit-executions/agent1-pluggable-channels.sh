#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent1-pluggable-channels.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent1-pluggable-channels.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent1-pluggable-channels.output"
REC_ID="agent1-pluggable-channels"
