#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent3-recipes-sauces-dips.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent3-recipes-sauces-dips.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent3-recipes-sauces-dips.output"
REC_ID="agent3-recipes-sauces-dips"
