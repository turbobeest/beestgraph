#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent2-obsidian-workflows.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent2-obsidian-workflows.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent2-obsidian-workflows.output"
REC_ID="agent2-obsidian-workflows"
