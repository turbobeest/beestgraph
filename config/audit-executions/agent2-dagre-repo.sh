#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent2-dagre-repo.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent2-dagre-repo.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent2-dagre-repo.output"
REC_ID="agent2-dagre-repo"
