#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent3-lemon-curd.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent3-lemon-curd.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent3-lemon-curd.output"
REC_ID="agent3-lemon-curd"
