#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent1-bks.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent1-bks.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent1-bks.output"
REC_ID="agent1-bks"
