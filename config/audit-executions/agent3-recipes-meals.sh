#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent3-recipes-meals.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent3-recipes-meals.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent3-recipes-meals.output"
REC_ID="agent3-recipes-meals"
