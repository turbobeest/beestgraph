#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent2-camping-list.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent2-camping-list.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent2-camping-list.output"
REC_ID="agent2-camping-list"
