#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent3-chicago-pizza-oven-grinder.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent3-chicago-pizza-oven-grinder.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent3-chicago-pizza-oven-grinder.output"
REC_ID="agent3-chicago-pizza-oven-grinder"
