#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent1-zettelkasten-method.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent1-zettelkasten-method.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent1-zettelkasten-method.output"
REC_ID="agent1-zettelkasten-method"
