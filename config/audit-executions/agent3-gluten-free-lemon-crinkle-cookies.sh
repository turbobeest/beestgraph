#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent3-gluten-free-lemon-crinkle-cookies.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent3-gluten-free-lemon-crinkle-cookies.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent3-gluten-free-lemon-crinkle-cookies.output"
REC_ID="agent3-gluten-free-lemon-crinkle-cookies"
