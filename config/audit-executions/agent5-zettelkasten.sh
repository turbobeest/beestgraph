#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent5-zettelkasten.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent5-zettelkasten.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent5-zettelkasten.output"
REC_ID="agent5-zettelkasten"
