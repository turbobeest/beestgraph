#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent1-privacy-barriers.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent1-privacy-barriers.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent1-privacy-barriers.output"
REC_ID="agent1-privacy-barriers"
