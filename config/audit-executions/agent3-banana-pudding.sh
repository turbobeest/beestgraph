#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent3-banana-pudding.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent3-banana-pudding.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent3-banana-pudding.output"
REC_ID="agent3-banana-pudding"
