#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent1-security-scanner.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent1-security-scanner.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent1-security-scanner.output"
REC_ID="agent1-security-scanner"
