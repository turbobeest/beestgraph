#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent5-personal-knowledge-management.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent5-personal-knowledge-management.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent5-personal-knowledge-management.output"
REC_ID="agent5-personal-knowledge-management"
