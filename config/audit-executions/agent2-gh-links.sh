#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent2-gh-links.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent2-gh-links.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent2-gh-links.output"
REC_ID="agent2-gh-links"
