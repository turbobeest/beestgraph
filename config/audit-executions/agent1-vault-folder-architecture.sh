#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent1-vault-folder-architecture.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent1-vault-folder-architecture.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent1-vault-folder-architecture.output"
REC_ID="agent1-vault-folder-architecture"
