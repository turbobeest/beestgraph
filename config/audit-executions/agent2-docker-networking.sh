#!/bin/bash
STATUS="/home/turbobeest/beestgraph/config/audit-executions/agent2-docker-networking.json"
AUDIT="/home/turbobeest/beestgraph/config/audit-recommendations.json"
PROMPT="/home/turbobeest/beestgraph/config/audit-executions/agent2-docker-networking.prompt"
CLAUDE="/home/turbobeest/.local/bin/claude"
OUTPUT="/home/turbobeest/beestgraph/config/audit-executions/agent2-docker-networking.output"
REC_ID="agent2-docker-networking"
