...
_TOPIC_KEYWORDS: dict[str, list[str]] = {
    "technology/programming": [
        "python", "javascript", "typescript", "rust", "golang", "api", "sdk",
        "framework", "library", "git", "code", "software", "developer",
    ],
    "technology/ai-ml": [
    ...
    "technology/infrastructure": [
        "docker", "kubernetes", "linux", "server", "cloud", "aws", "deploy",
        "ci/cd", "terraform", "ansible", "raspberry pi",
    ],
    "technology/security": [
        "security", "vulnerability", "encryption", "auth", "oauth", "firewall",
        "vpn", "tailscale", "zero trust",
    ],
    "technology/web": [
        "react", "next.js", "html", "css", "frontend", "backend", "browser",
        "web", "http", "rest",
    ],
    ...
    "meta/pkm": [
        "knowledge graph", "obsidian", "zettelkasten", "note-taking", "pkm",
